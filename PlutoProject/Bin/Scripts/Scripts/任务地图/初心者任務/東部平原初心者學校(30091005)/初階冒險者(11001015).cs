...
//所在地圖:東部平原初心者學校(30091005) NPC基本信息:初階冒險者(11001015) X:8 Y:9
namespace SagaScript.M30091005
{
    public class S11001015 : Event
    {
        public S11001015()
        {
            this.EventID = 11001015;
        }
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            Say(pc, 11001015, 0, "啊，您好!$R;", "初阶冒险者");
        }
