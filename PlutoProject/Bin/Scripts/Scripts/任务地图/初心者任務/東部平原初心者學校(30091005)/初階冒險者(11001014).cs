...
//所在地圖:東部平原初心者學校(30091005) NPC基本信息:初階冒險者(11001014) X:4 Y:6
namespace SagaScript.M30091005
{
    public class S11001014 : Event
    {
        public S11001014()
        {
            this.EventID = 11001014;
        }
        ...
        void 初次與初階冒險者進行對話(ActorPC pc)
        {
            ...
            while (selection != 3)
            {
                switch (selection)
                {
                    ...
                    case 2:
                        Say(pc, 11001014, 0, "这个头发是在「阿克罗波利斯」的「上城」的$R;" +
                                             "「尼贝隆肯发型屋」弄得!$R;" +
                                             "$P那里有个语气奇怪的发型师，$R;" +
                                             "他会剪头发和设计造型喔!$R;" +
                                             "$P啊! 这个头发有店特别吧!$R;" +
