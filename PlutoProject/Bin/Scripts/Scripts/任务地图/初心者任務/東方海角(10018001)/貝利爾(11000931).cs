    ...
    public class S11000931 : Event
    {
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            while (selection != 5)
            {
                ...
                {
                    case 1:
                        Say(pc, 11000931, 131, "说明道具的使用方法之前，$R;" +
                                               "先来看看基本操作吧!$R;", "贝利尔");

                        Say(pc, 11000931, 131, "「道具」、「技能」；「装备」$R;" +
                                               "视窗打开了吗?$R;" +
                                               "$R这三种都可以在主视窗做开关哦!$R;" +
                                               "$P跟我说话的时候，$R;" +
                                               "也可以一边操作，$R;" +
                    ...
                    case 2:
                        if (!Beginner_01_mask.Test(Beginner_01.已經與貝利爾進行過戰鬥教學))
                        {
                            ...
                            Say(pc, 11000931, 131, "透过实际作战，最容易了解了，$R;" +
                                                   "但要先告诉您一些注意事项哦!$R;" +
                                                   "主视窗的「HP」「MP」「SP」$R;" +
                                                   "这三个数值。$R;" +
                                                   "$P在战斗时一定要注意。$R;" +
                        ...
                        {
                            Say(pc, 11000931, 131, "还想听关于战斗吗? 现在做简单说明。$R;" +
                                                   "$P战斗时，要注意以下几点哦!$R;" +
                                                   "主视窗的「HP」「MP」「SP」$R;" +
                                                   "这三个数值。$R;" +
                                                   "$P战斗时一定要注意。$R;" +
                    ...
                    case 3:
                        if (!Beginner_01_mask.Test(Beginner_01.已經與貝利爾進行過技能教學))
                        {
                            ...
                            Say(pc, 11000931, 131, "那么现在为您解释「技能」吧!$R;" +
                                                   "$P「初心者」时，只能普通攻击。$R;" +
                                                   "$R转职后，才可以使用各种技能唷!$R;" +
                                                   "$P怎么样，想试试吗?$R;", "贝利尔");
                            ...
                            switch (Select(pc, "想要试一下技能吗?", "", "想试试", "听说明就够了"))
                            {
                                case 1:
                                    ...
                                    Say(pc, 0, 0, "取得了技能石『力量墙』$R;", " ");

                                    Say(pc, 11000931, 131, "刚才给您的叫技能石，$R;" +
                                                           "是只能使用一次技能的道具呀!$R;" +
                                                           "$P使用这石头就可以$R;" +
                                                           "体验「力量提升」的技能喔!$R;" +
                                                           "$R这是可以马上提高$R;" +
                                ...
                                case 2:
                                    Say(pc, 11000931, 131, "技能指的是，$R;" +
                                                           "消耗SP值和MP值$R;" +
                                                           "来使用的「技术」和「魔法」哦!$R;", "贝利尔");

                                    Say(pc, 11000931, 131, "您现在可以打开「技能视窗」，$R;" +
                                                           "熟悉或使用技能。$R;" +
                                                           "$P想要知道效果，$R;" +
                                                           "可以点击「技能视窗」的图示进行确认。$R;" +
                                                           "还有，有一些技能，$R;" +
                                                           ...
                                                           "可以坐着恢复，$R;" +
                                                           "也可以使用道具，$R;" +
                                                           "或者是在城市/帐篷里自动恢复哦!$R;", "贝利尔");
                                    break;
                            }
                        }
                        else
                        {
                            Say(pc, 11000931, 131, "想再听一遍吗?$R;" +
                                                   "$R第二次就不能试验道具啰。$R;" +
                                                   "那就做个简单的说明吧!$R;" +
                                                   "技能指的是，消耗SP值跟MP值，$R;" +
                                                   "来使用的「技术」和「魔法」哦!$R;", "贝利尔");
                    ...
                    case 4:
                        Say(pc, 11000931, 131, "「奖励点数」是提高自己$R;" +
                                               "各种能力值的非常重要的点数!$R;" +
                                               "$P先暂时打开状态视窗吧!$R;" +
                                               "$P打开了吗?$R;" +
                                               "$P视窗右下方有个小的「+」键对吧?$R;" +
            ...
            Say(pc, 11000931, 131, "下一个地图，玛莎会告诉您的。$R;" +
                                   "$P她是个埃米尔族的女孩，$R;" +
                                   "虽然有点麻烦呀!$R;" +
                                   "$R刚刚说的不要告诉玛莎喔!$R;" +
                                   "$R玛莎会告诉您有关$R;" +
        ...
        void 初次與貝利爾進行對話(ActorPC pc)
        {
            ...
            Say(pc, 11000931, 131, "很高兴第一次见到你，$R;" +
                                   "我叫贝利尔。$R;" +
                                   "$R从埃米尔那里受了委托，$R;" +
                                   "为刚来的人介绍各种事情!$R;" +
                                   "$P说来话长…$R;" +
            ...
            switch (Select(pc, "要从哪开始听?", "", "我想要从头开始听!", "跳过战斗指导部分", "到指导的最后部分"))
            {
                case 1:
                    Say(pc, 11000931, 131, "好了吗? 那么开始吧!$R;" +
                                           "$R我只告诉你基本的概念，$R;" +
                                           "其他的你自己修炼吧!$R;", "贝利尔");
                    break;

                case 2:
                    Say(pc, 11000931, 131, "哦? 是吗?$R;" +
                                           "跟我没关系呢…$R;", "贝利尔");
        ...
        void 戰鬥教學(ActorPC pc)
        {
            ...
            if (!Beginner_01_mask.Test(Beginner_01.HP恢復教學完成))
            {
                ...
                Say(pc, 11000931, 131, "大概知道是什么意思了吧?$R;" +
                                       "当你HP值下降，就吃这个吧!$R;", "贝利尔");
        ...
        void 技能教學(ActorPC pc)
        {
            ...
            if (!Beginner_01_mask.Test(Beginner_01.得到第二顆技能石))
            {
                ...
                Say(pc, 11000931, 131, "怎么样?$R;" +
                                       "攻击力量是不是变强了?$R;", "贝利尔");

                PlaySound(pc, 2040, false, 100, 50);
                GiveItem(pc, 20050005, 1);
                Say(pc, 0, 0, "取得了技能石『技能石·烈焰风暴』$R;", " ");

                Say(pc, 11000931, 131, "第二种技能是「烈焰风暴」喔!$R;" +
                                       "$R就是其中一种「魔法」技能，$R;" +
                                       "用来催化世界上存在的各种力量。$R;" +
                                       "$P选择魔法师系列的职业，$R;" +
                                       "就可以学到哦!$R;" +
            ...
            if (!Beginner_01_mask.Test(Beginner_01.得到第三顆技能石))
            {
                ...
                Say(pc, 11000931, 131, "怎么样? 使用华丽的技能，$R;" +
                                       "很爽吧?$R;", "贝利尔");
                ...
                Say(pc, 11000931, 131, "第三种技能是「旋风剑」喔!$R;" +
                                       "$P使用这个技能，$R;" +
                                       "会给魔物非常强烈的打击呀!$R;" +
                                       "$R这种叫「技术」的技能，$R;" +
                                       "主要是给战士系列职业学的技能哦!$R;" +
            ...
            else
            {
                ...
                Say(pc, 11000931, 131, "有没有喜欢的技能呢?$R;" +
                                       "试验技能已经完毕啰。$R;" +
                                       "$P各职业使用技能，$R;" +
                                       "都会消耗MP值和SP值喔!$R;" +
                                       "$R所以不仅HP值，$R;" +
        ...
        void 貝利爾給予初心者緞帶(ActorPC pc)
        {
            ...
            Say(pc, 11000931, 131, "给您的『初心者缎带』，$R;" +
                                   "看名称就知道是初心者用的装备。$R;" +
                                   "$R装备『初心者缎带』时，$R;" +
                                   "只要双击道具就可以了，$R;" +
                                   "以后再带吧!$R;" +
