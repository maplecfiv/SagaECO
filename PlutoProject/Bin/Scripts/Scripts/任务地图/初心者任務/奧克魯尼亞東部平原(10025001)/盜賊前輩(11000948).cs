...
//所在地圖:奧克魯尼亞東部平原(10025001) NPC基本信息:盜賊前輩(11000948) X:150 Y:104
namespace SagaScript.M10025001
{
    public class S11000948 : Event
    {
        public S11000948()
        {
            this.EventID = 11000948;
        }
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            Say(pc, 11000948, 0, "…是初心者吗?$R;" +
                                 "$R对战士系职业，有什么想知道的吗?$R;", "盗贼前辈");
