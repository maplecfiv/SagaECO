...
//所在地圖:奧克魯尼亞東部平原(10025001) NPC基本信息:騎士前輩(11000947) X:152 Y:104
namespace SagaScript.M10025001
{
    public class S11000947 : Event
    {
        public S11000947()
        {
            this.EventID = 11000947;
        }
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            Say(pc, 11000947, 0, "是初心者啊!$R;" +
                                 "$R对战士系职业，有什么想知道的吗?$R;", "骑士前辈");
