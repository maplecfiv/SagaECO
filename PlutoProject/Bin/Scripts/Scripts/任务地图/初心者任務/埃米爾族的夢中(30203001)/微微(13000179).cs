...
using SagaLib;
//所在地圖:埃米爾族的夢中(30203001) NPC基本信息:微微(13000179) X:15 Y:20
namespace SagaScript.M30203001
{
    public class S13000179 : Event
    {
        public S13000179()
        {
            this.EventID = 13000179;
        }
...
namespace SagaScript.M30203001
{
    public class S18000183 : Event
    {
        public S18000183()
        {
            this.EventID = 18000183;
        }
