    ...
    public class S11001082 : Event
    {
        ...
        public override void OnEvent(ActorPC pc)
        {
                ...
                !Neko_03_cmask.Test(Neko_03.再次與破多加對話))
            {
                ...
                //MUSIC 1141 0 0 100
                Wait(pc, 1000);
                Say(pc, 11001092, 131, "这短剑…$R是我跟那女子分手的时候$R留给她的信物啊$R;" +
                    "$P而且头发、眼珠…$R真的跟她很像阿$R;" +
                    "$R你真的是我……$R;");
        ...
        void 得到堇子(ActorPC pc)
        {
            ...
            if (CheckInventory(pc, 10017906, 1))
            {
                ...
                {
                    Say(pc, 11001092, 131, "理路是说这姐姐吧$R她带着其他猫灵同伴呢$R;" +
                        "$R让我可以跟同伴一起吧$R把我送走$R你身边就没有我帮忙了$R;");
                }
                else
                {
                    Say(pc, 11001092, 131, "理路！是说这哥哥吧$R还有其他猫灵同伴$R;" +
                        "$R让我可以跟同伴一起吧$R把我送走$R你身边就没有我帮忙了$R;");
                }
        ...
        void 對話分支1(ActorPC pc)
        {
            ...
            Say(pc, 0, 131, "…原来…桃子…$R为了我们$R一直装着坚强开朗……$R;", "猫灵（山吹）");
        }
