...
{
    public class S11001219 : Event
    {
        public S11001219()
        {
            this.EventID = 11001219;
        }
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            //EVT11001219
            if (Neko_05_amask.Test(Neko_05.茜子任务开始) && Neko_05_cmask.Test(Neko_05.把電腦唯讀記憶體給哈爾列爾利) && !Neko_05_cmask.Test(Neko_05.飛空庭完成) && CountItem(pc, 10057900) >= 1)
            {
                Say(pc, 11001218, 131, "一起去我的飛空庭嗎?$R;");
                去哈爾列爾利的飛空庭(pc);
                return;
            }
            if (Neko_05_amask.Test(Neko_05.茜子任务开始) && Neko_05_cmask.Test(Neko_05.进入光塔) && !Neko_05_cmask.Test(Neko_05.把電腦唯讀記憶體給哈爾列爾利) && CountItem(pc, 10057900) >= 1)
            {
                Wait(pc, 333);
            ...
            if ((Neko_05_amask.Test(Neko_05.茜子任务开始) &&
                ...
                !Neko_05_cmask.Test(Neko_05.去哈爾列爾利的飛空庭)))
            {
                Say(pc, 11001219, 131, "哈利路亚！$R;" +
                    "$R身体如何?有没有什么地方不舒服?$R;");
                Say(pc, 11001218, 131, "…?为什么突然这样?$R;" +
                    "$R我很健康啊♪$R;");
                return;
            }
            if (Neko_05_amask.Test(Neko_05.茜子任务开始) &&
            ...
            if (Neko_05_amask.Test(Neko_05.茜子任务开始) &&
                ...
                !Neko_05_cmask.Test(Neko_05.去哈爾列爾利的飛空庭))
            {
                Say(pc, 11001219, 131, "这孩子真是的！$R哈利路亚就拜托您了！$R;");
                return;
            }
            Say(pc, 11001219, 131, "哈利路亚！就是像那样…$R;");
            哈爾列爾利(pc);
        }

        void 哈爾列爾利(ActorPC pc)
        {
            BitMask<Neko_05> Neko_05_amask = pc.AMask["Neko_05"];
            BitMask<Neko_05> Neko_05_cmask = pc.CMask["Neko_05"];

            if (Neko_05_amask.Test(Neko_05.茜子任务开始) && Neko_05_cmask.Test(Neko_05.把電腦唯讀記憶體給哈爾列爾利) && !Neko_05_cmask.Test(Neko_05.飛空庭完成))
            {
            ...
            if (Neko_05_amask.Test(Neko_05.茜子任务开始) && Neko_05_cmask.Test(Neko_05.进入光塔) && !Neko_05_cmask.Test(Neko_05.把電腦唯讀記憶體給哈爾列爾利) && CountItem(pc, 10057900) >= 1)
            {
                ...
                TakeItem(pc, 10057900, 1);
                TakeItem(pc, 10057380, 1);
                Say(pc, 0, 131, "把『电脑唯读记忆体』给哈利路亚了！$R;");
                Wait(pc, 1000);
                Neko_05_cmask.SetValue(Neko_05.把電腦唯讀記憶體給哈爾列爾利, true);
                Say(pc, 11001218, 131, "妈妈！！我回来了！！$R;");
                Say(pc, 11001219, 131, "回来了?$R;" +
        ...
        void 去哈爾列爾利的飛空庭(ActorPC pc)
        {
            ...
            {
                case 1:
                    pc.CInt["Neko_05_Map_05"] = CreateMapInstance(50019000, 10062000, 110, 87);
                    Warp(pc, (uint)pc.CInt["Neko_05_Map_05"], 7, 12);
