...
namespace SagaLib
{
    ...
    public enum Race
    {
        ...
        ///     人形
        /// </summary>
        [Description("人形")] HUMAN = 1,

        /// <summary>
        ///     植物
        /// </summary>
        [Description("植物")] PLANT = 2,

        /// <summary>
        ///     元素
        /// </summary>
        [Description("元素生物")] ELEMENT = 4,

        /// <summary>
        ///     岩石
        /// </summary>
        [Description("岩石")] ROCK = 8,

        /// <summary>
        ///     不死
        /// </summary>
        [Description("不死")] UNDEAD = 16,

        /// <summary>
        ///     飞鸟
        /// </summary>
        [Description("飞鸟")] BIRD = 32,

        /// <summary>
        ///     昆虫
        /// </summary>
        [Description("昆虫")] INSECT = 64,

        /// <summary>
        ///     动物
        /// </summary>
        [Description("动物")] ANIMAL = 128,

        /// <summary>
        ///     魔法生物
        /// </summary>
        [Description("魔法生物")] MAGIC_CREATURE = 256,

        /// <summary>
        ///     机械
        /// </summary>
        [Description("机械")] MACHINE = 512,

        /// <summary>
        ///     鱼贝
        /// </summary>
        [Description("鱼贝")] WATER_ANIMAL = 1024
    }
    ...
    public enum Elements
    {
        ...
        ///     无属性
        /// </summary>
        [Description("无属性")] Neutral = 0,

        /// <summary>
        ///     火
        /// </summary>
        [Description("火属性")] Fire = 1,

        /// <summary>
        ///     水
        /// </summary>
        [Description("水属性")] Water = 2,

        /// <summary>
        ///     风
        /// </summary>
        [Description("风属性")] Wind = 3,

        /// <summary>
        ///     地
        /// </summary>
        [Description("地属性")] Earth = 4,

        /// <summary>
        ///     光
        /// </summary>
        [Description("光属性")] Holy = 5,

        /// <summary>
        ///     暗
        /// </summary>
        [Description("暗属性")] Dark = 6
    }
    ...
    public static class Conversions
    {
        ...
        public static string uint2HexString(uint[] b)
        {
            ...
            for (i = 0; i < b.Length; i++)
            {
                var tmp2 = Conversion.Hex(b[i]);
                if (tmp2.Length != 8)
                    for (var j = 0; j < 8 - tmp2.Length; j++)
                        tmp2 = "0" + tmp2;
    ...
    public static class Global
    {
        ...
        {
            var val = (double)width / 2;
            var tmp = (float)(pos - 50) / 100 + val;
            if (tmp < 0)
                tmp = 0;
            return (byte)tmp;
        }
