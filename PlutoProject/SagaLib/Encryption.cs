...
namespace SagaLib {
    public class Encryption {
        ...
        public void MakePrivateKey() {
            ...
            sha.TransformBlock(
                System.Text.Encoding.ASCII.GetBytes(DateTime.Now.ToString() + DateTime.Now.ToUniversalTime() +
        ...
        public void MakeAESKey(string keyExchangeBytes) {
            BigInteger A = new BigInteger(Conversions.HexStr2Bytes(keyExchangeBytes));
