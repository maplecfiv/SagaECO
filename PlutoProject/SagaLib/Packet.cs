...
namespace SagaLib
{
    ...
    public class Packet
    {
        ...
        /// <summary>
        ///     The size of the packet is equal to the number of data bytes plus 2 bytes for the message id plus 2 bytes for the
        ///     size.
        /// </summary>
        public uint size;
        ...
        public void PutBytes(byte[] bdata, ushort index)
        {
            ...
            if (index + bdata.Length <= data.Length)
