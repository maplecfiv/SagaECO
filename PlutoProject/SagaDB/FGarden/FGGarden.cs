...
namespace SagaDB.FlyingGarden
{
    ...
    public class FlyingGarden
    {
        ...
        Dictionary<FurniturePlace, List<ActorFurniture>> furnitures = new Dictionary<FurniturePlace, List<ActorFurniture>>();
        ...
        /// 飞空庭绳子的Actor
        /// </summary>
        public ActorEvent RopeActor { get { return ropeActor; } set { ropeActor = value; } }

        /// <summary>
        /// 飞空庭地图ID
        /// </summary>
        public uint MapID { get { return mapID; } set { mapID = value; } }

        /// <summary>
        /// 飞空庭房间地图ID
        /// </summary>
        public uint RoomMapID { get { return roomMapID; } set { roomMapID = value; } }

        /// <summary>
        /// 飞空庭的装备
        /// </summary>
        public Dictionary<FlyingGardenSlot, uint> FlyingGardenEquipments { get { return equips; } }

        /// <summary>
        /// 飞空庭的家具
        /// </summary>
        public Dictionary<FurniturePlace, List<ActorFurniture>> Furnitures { get { return furnitures; } }
