...
namespace SagaDB.Actor
{
    public class Status
    {
        ...
        public Dictionary<Elements, int> attackelements_iris = new Dictionary<Elements, int>();
        public Dictionary<Elements, int> attackElements_item = new Dictionary<Elements, int>();
        public Dictionary<Elements, int> attackElements_skill = new Dictionary<Elements, int>();
        ...
        public short avoid_melee_iris,
            avoid_ranged_iris,
            avoid_magic_iris,
            avoid_critical_iris,
            avoid_melee_rate_iris = 100,
            avoid_ranged_rate_iris = 100,
            avoid_magic_rate_iris = 100,
            avoid_critical_rate_iris = 100;
        ...
        public Dictionary<Elements, int> elements_iris = new Dictionary<Elements, int>();

        //Element 
        public Dictionary<Elements, int> elements_item = new Dictionary<Elements, int>();
        public Dictionary<Elements, int> elements_skill = new Dictionary<Elements, int>();
        public short foot_iris = 100, potion_iris = 100; //食物和药水
        public short guard;
        public short guard_bs;
        public short guard_iris, volume_iris, payl_add_iris, volume_add_iris; //负重体积相关
        ...
        public short hit_melee_iris,
            hit_ranged_iris,
            hit_magic_iris,
            hit_critical_iris,
            hit_melee_rate_iris = 100,
            hit_ranged_rate_iris = 100,
            hit_magic_rate_iris = 100,
            hit_critical_rate_iris = 100;
        ...
        public short human_avoid_up_iris = 100,
            bird_avoid_up_iris = 100,
            animal_avoid_up_iris = 100,
            insect_avoid_up_iris = 100,
            magic_c_avoid_up_iris = 100,
            plant_avoid_up_iris = 100,
            water_a_avoid_up_iris = 100,
            machine_avoid_up_iris = 100,
            rock_avoid_up_iris = 100,
            element_avoid_up_iris = 100,
            undead_avoid_up_iris = 100; //种族回避提升参数

        public short human_cri_up_iris = 0,
            bird_cri_up_iris = 0,
            animal_cri_up_iris = 0,
            insect_cri_up_iris = 0,
            magic_c_cri_up_iris = 0,
            plant_cri_up_iris = 0,
            water_a_cri_up_iris = 0,
            machine_cri_up_iris = 0,
            rock_cri_up_iris = 0,
            element_cri_up_iris = 0,
            undead_cri_up_iris = 0; //对种族暴击提升参数

        public short human_dmg_down_iris = 100,
            bird_dmg_down_iris = 100,
            animal_dmg_down_iris = 100,
            insect_dmg_down_iris = 100,
            magic_c_dmg_down_iris = 100,
            plant_dmg_down_iris = 100,
            water_a_dmg_down_iris = 100,
            machine_dmg_down_iris = 100,
            rock_dmg_down_iris = 100,
            element_dmg_down_iris = 100,
            undead_dmg_down_iris = 100; //种族减伤参数

        public short human_dmg_up_iris = 100,
            bird_dmg_up_iris = 100,
            animal_dmg_up_iris = 100,
            insect_dmg_up_iris = 100,
            magic_c_dmg_up_iris = 100,
            plant_dmg_up_iris = 100,
            water_a_dmg_up_iris = 100,
            machine_dmg_up_iris = 100,
            rock_dmg_up_iris = 100,
            element_dmg_up_iris = 100,
            undead_dmg_up_iris = 100; //对种族增伤参数

        public short human_hit_up_iris = 100,
            bird_hit_up_iris = 100,
            animal_hit_up_iris = 100,
            insect_hit_up_iris = 100,
            magic_c_hit_up_iris = 100,
            plant_hit_up_iris = 100,
            water_a_hit_up_iris = 100,
            machine_hit_up_iris = 100,
            rock_hit_up_iris = 100,
            element_hit_up_iris = 100,
            undead_hit_up_iris = 100; //对种族命中提升参数

        public short level_hit_iris, level_avoid_iris; //等级差命中与回避
        ...
        public short min_atk1_rate_iris = 100,
            min_atk2_rate_iris = 100,
            min_atk3_rate_iris = 100,
            max_atk1_rate_iris = 100,
            max_atk2_rate_iris = 100,
            max_atk3_rate_iris = 100,
            min_matk_rate_iris = 100,
            max_matk_rate_iris = 100;

        public short min_atk1_rate_skill = 100,
            min_atk2_rate_skill = 100,
            min_atk3_rate_skill = 100,
            max_atk1_rate_skill = 100,
            max_atk2_rate_skill = 100,
            max_atk3_rate_skill = 100,
            min_matk_rate_skill = 100,
            max_matk_rate_skill = 100;
        ...
        //Iris Card bonus
        public short weapon_add_iris, weapon_add_rate_iris; //武器伤害直接增加用参数
        ...
        public Status(Actor owner)
        {
            ...
            elements_item.Add(Elements.Water, 0);
            elements_item.Add(Elements.Wind, 0);
            elements_item.Add(Elements.Earth, 0);
            elements_item.Add(Elements.Holy, 0);
            elements_item.Add(Elements.Dark, 0);
            attackElements_item.Add(Elements.Neutral, 0);
            attackElements_item.Add(Elements.Fire, 0);
            attackElements_item.Add(Elements.Water, 0);
            attackElements_item.Add(Elements.Wind, 0);
            attackElements_item.Add(Elements.Earth, 0);
            attackElements_item.Add(Elements.Holy, 0);
            attackElements_item.Add(Elements.Dark, 0);
            elements_iris.Add(Elements.Neutral, 0);
            elements_iris.Add(Elements.Fire, 0);
            elements_iris.Add(Elements.Water, 0);
            elements_iris.Add(Elements.Wind, 0);
            elements_iris.Add(Elements.Earth, 0);
            elements_iris.Add(Elements.Holy, 0);
            elements_iris.Add(Elements.Dark, 0);
            attackelements_iris.Add(Elements.Neutral, 0);
            attackelements_iris.Add(Elements.Fire, 0);
            attackelements_iris.Add(Elements.Water, 0);
            attackelements_iris.Add(Elements.Wind, 0);
            attackelements_iris.Add(Elements.Earth, 0);
            attackelements_iris.Add(Elements.Holy, 0);
            attackelements_iris.Add(Elements.Dark, 0);
            elements_skill.Add(Elements.Neutral, 0);
            elements_skill.Add(Elements.Fire, 0);
            elements_skill.Add(Elements.Water, 0);
            elements_skill.Add(Elements.Wind, 0);
            elements_skill.Add(Elements.Earth, 0);
            elements_skill.Add(Elements.Holy, 0);
            elements_skill.Add(Elements.Dark, 0);
            attackElements_skill.Add(Elements.Neutral, 0);
            attackElements_skill.Add(Elements.Fire, 0);
            attackElements_skill.Add(Elements.Water, 0);
            attackElements_skill.Add(Elements.Wind, 0);
            attackElements_skill.Add(Elements.Earth, 0);
            attackElements_skill.Add(Elements.Holy, 0);
        ...
        public void ClearItem()
        {
            ...
            mp_recover_item = 0;
            sp_recover_item = 0;
            elements_item[Elements.Neutral] = 0;
            elements_item[Elements.Fire] = 0;
            elements_item[Elements.Water] = 0;
            elements_item[Elements.Wind] = 0;
            elements_item[Elements.Earth] = 0;
            elements_item[Elements.Holy] = 0;
            elements_item[Elements.Dark] = 0;
            attackElements_item[Elements.Neutral] = 0;
            attackElements_item[Elements.Fire] = 0;
            attackElements_item[Elements.Water] = 0;
            attackElements_item[Elements.Wind] = 0;
            attackElements_item[Elements.Earth] = 0;
            attackElements_item[Elements.Holy] = 0;
            attackElements_item[Elements.Dark] = 0;
            cri_item = 0;
            avoid_critical_item = 0;
            criavd_item = 0;
            SkillDamage.Clear();
            ...
            sp_rate_iris = 100;
            mp_rate_iris = 100;
            sp_rate_down_iris = 100;
            mp_rate_down_iris = 100;
            hp_recover_iris = 0;
            mp_recover_iris = 0;
            sp_recover_iris = 0;
            hit_melee_rate_iris = 100;
            ...
            avoid_ranged_rate_iris = 100;
            weapon_add_iris = 0;
            weapon_add_rate_iris = 0;
            level_avoid_iris = 0;
            level_hit_iris = 0;
            avoid_end_rate = 100;
            physice_rate_iris = 100;
            magic_rate_iris = 100;
            pt_dmg_down_iris = 100;
            pt_dmg_up_iris = 100;
            Element_down_iris = 100;
            human_dmg_up_iris = 100;
            bird_dmg_up_iris = 100;
            animal_dmg_up_iris = 100;
            insect_dmg_up_iris = 100;
            magic_c_dmg_up_iris = 100;
            ...
            rock_dmg_up_iris = 100;
            element_dmg_up_iris = 100;
            undead_dmg_up_iris = 100;
            human_dmg_down_iris = 100;
            bird_dmg_down_iris = 100;
            animal_dmg_down_iris = 100;
            insect_dmg_down_iris = 100;
            magic_c_dmg_down_iris = 100;
            ...
            rock_dmg_down_iris = 100;
            element_dmg_down_iris = 100;
            undead_dmg_down_iris = 100;
            human_hit_up_iris = 100;
            bird_hit_up_iris = 100;
            animal_hit_up_iris = 100;
            insect_hit_up_iris = 100;
            magic_c_hit_up_iris = 100;
            ...
            rock_hit_up_iris = 100;
            element_hit_up_iris = 100;
            undead_hit_up_iris = 100;
            human_avoid_up_iris = 100;
            bird_avoid_up_iris = 100;
            animal_avoid_up_iris = 100;
            insect_avoid_up_iris = 100;
            magic_c_avoid_up_iris = 100;
            ...
            rock_avoid_up_iris = 100;
            element_avoid_up_iris = 100;
            undead_avoid_up_iris = 100;
            human_avoid_up_iris = 0;
            bird_avoid_up_iris = 0;
            animal_avoid_up_iris = 0;
            insect_avoid_up_iris = 0;
            magic_c_avoid_up_iris = 0;
            plant_avoid_up_iris = 0;
            water_a_avoid_up_iris = 0;
            machine_avoid_up_iris = 0;
            rock_avoid_up_iris = 0;
            element_avoid_up_iris = 0;
            undead_avoid_up_iris = 0;
            //short foot_iris = 0, potion_iris
            foot_iris = 100;
            potion_iris = 100;
            elements_iris[Elements.Neutral] = 0;
            elements_iris[Elements.Fire] = 0;
            elements_iris[Elements.Water] = 0;
            elements_iris[Elements.Wind] = 0;
            elements_iris[Elements.Earth] = 0;
            elements_iris[Elements.Holy] = 0;
            elements_iris[Elements.Dark] = 0;
            attackelements_iris[Elements.Neutral] = 0;
            attackelements_iris[Elements.Fire] = 0;
            attackelements_iris[Elements.Water] = 0;
            attackelements_iris[Elements.Wind] = 0;
            attackelements_iris[Elements.Earth] = 0;
            attackelements_iris[Elements.Holy] = 0;
            attackelements_iris[Elements.Dark] = 0;
            PhysiceReduceRate = 0;
        }
