...
{
    public class S11000879 : Event
    {
        public S11000879()
        {
            this.EventID = 11000879;
        }
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            {
                Say(pc, 11000879, 131, "现在正调查犯罪现场$R不要妨碍调查$R;");
                return;
            }
            ...
            {
                Say(pc, 11000879, 131, "差一点出大事了…$R现在可以走了$R;");
                return;
            }
            Say(pc, 11000879, 131, "现在正调查犯罪现场$R结束之前不能回去$R;");
        }
    }
}