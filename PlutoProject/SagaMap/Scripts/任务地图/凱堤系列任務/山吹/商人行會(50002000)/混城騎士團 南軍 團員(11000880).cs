...
{
    public class S11000880 : Event
    {
        public S11000880()
        {
            this.EventID = 11000880;
        }
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            {
                Say(pc, 11000880, 131, "现在正调查犯罪现场$R不要妨碍调查啊$R;");
                return;
            }
            ...
            {
                Say(pc, 11000880, 131, "差一点出大事了…$R现在可以走了$R;");
                return;
            }
            Say(pc, 11000880, 131, "现在正调查犯罪现场$R结束之前不能回去$R;");
        }
    }
}