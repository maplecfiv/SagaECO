...
//所在地圖:東方海角(10018101) NPC基本信息:裝備技術人員(11000974) X:195 Y:69
namespace SagaScript.M10018101
{
    public class S11000974 : Event
    {
        public S11000974()
        {
            this.EventID = 11000974;
        }
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            while (selection != 3)
            {
                switch (selection)
                {
                    ...
                    case 2:
                        Say(pc, 11000974, 131, "至于道具票交换机，$R;" +
                                               "先点击这个机械，$R;" +
                                               "然后选择「道具票交换」。$R;" +
                                               "$P需要输入编号时，$R;" +
                                               "在输入视窗输入正确「道具编号」。$R;" +
        ...
        {
            Say(pc, 11000974, 131, "已经跟埃米尔打招呼了吗? $R;" +
                                   "最好先跟他谈谈喔!$R;", "装备技术人员");
        } 
    }
}
