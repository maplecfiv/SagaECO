...
namespace SagaScript.M30014000 {
    public class S11000003 : Event {
        ...
        void 交換合成失敗物(ActorPC pc) {
            ...
            switch (Select(pc, "想要交换什么?", "", "杰利科 (需要1个『合成失败物』)", "面包树果实 (需要10个『合成失败物』)", "蓝色杰利科 (需要100个『合成失败物』)",
                        "不想交换")) {
                case 1:
        ...
        void 製作電路機械(ActorPC pc) {
            ...
            switch (Select(pc, "欢迎光临!!", "", "买东西", "卖东西", "委托「组装机械」", "询问『活动木偶 电路机械』的制作方法", "委托打开『集装箱』", "交换『合成失败物』",
                        "什么也不做")) {
                case 1:
                    OpenShopBuy(pc, 6);
        ...
        void 活動木偶電路機械的製作方法(ActorPC pc) {
            ...
            while (selection != 5) {
                ...
                selection = Select(pc, "想要问什么呢?", "", "制作『发动机』的方法", "制作『电路机械的模型』的方法", "『掌上电脑』是什么", "制作『洋铁的身体』的方法",
                    "什么也不问");
            }
        }
