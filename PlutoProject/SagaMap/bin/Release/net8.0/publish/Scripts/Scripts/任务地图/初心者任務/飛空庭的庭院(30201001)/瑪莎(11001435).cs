...
namespace SagaScript.M30201001
{
    public class S11001435 : Event
    {
        ...
        void 與瑪莎進行第一次對話(ActorPC pc)
        {
            ...
            Say(pc, 11001435, 131, "欢迎来到飞空庭哦!$R;" +
                                   "$P飞空庭是飞在空中的家和庭园喔!$R;" +
                                   "$R在ECO世界，$R;" +
                                   "您可以拥有自己的房子和庭园。$R;" +
                                   "$P飞空庭是由「唐卡」的工匠制作的。$R;" +
        ...
        void 與瑪莎進行第二次對話(ActorPC pc)
        {
            ...
            if (Beginner_01_mask.Test(Beginner_01.發現床底下的東西))
            {
                ...
                Say(pc, 11001435, 131, "不是经常失败的，$R;" +
                                       "只是偶~~~尔吧!!$R;", "玛莎");

                Say(pc, 11001435, 134, "呜呜…$R;" +
                                       "$R本来想以后自己拿到古董商店那里的。$R;" +
                                       "$P现在去不去下一阶段呢?$R;", "玛莎");
            }
            ...
            switch (Select(pc, "去下一阶段吗?", "", "去下一阶段", "再告诉我一次关于飞空庭的情报", "再休息一会儿"))
            {
                ...
                case 2:
                    Say(pc, 11001435, 131, "飞空庭是由「唐卡」的工匠制作的哦!$R;" +
                                           "$R收集部件有点困难呀…$R;" +
                                           "$P对了!$R;" +
                                           "$R有个村落里有个工匠，找找看吧，$R;" +
                                           "他人挺好的，$R;" +
