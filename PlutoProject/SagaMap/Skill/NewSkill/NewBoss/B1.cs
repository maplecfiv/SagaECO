...
namespace SagaMap.Skill.NewSkill.NewBoss
{
    internal class B1 : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            var damagex1 = (short)(effectx1 + Global.PosX8to16(args.x, map.Width));
            var damagey1 = (short)(effecty1 + Global.PosY8to16(args.y, map.Height));
            var damagex2 = (short)(effectx2 + Global.PosX8to16(args.x, map.Width));
            var damagey2 = (short)(effecty2 + Global.PosY8to16(args.y, map.Height));
            var damagex3 = (short)(effectx3 + Global.PosX8to16(args.x, map.Width));
            var damagey3 = (short)(effecty3 + Global.PosY8to16(args.y, map.Height));
            var damagex4 = (short)(effectx4 + Global.PosX8to16(args.x, map.Width));
            var damagey4 = (short)(effecty4 + Global.PosY8to16(args.y, map.Height));
            var damagex5 = (short)(effectx5 + Global.PosX8to16(args.x, map.Width));
            var damagey5 = (short)(effecty5 + Global.PosY8to16(args.y, map.Height));
            var damagex6 = (short)(effectx6 + Global.PosX8to16(args.x, map.Width));
            var damagey6 = (short)(effecty6 + Global.PosY8to16(args.y, map.Height));
            var damagex7 = (short)(effectx7 + Global.PosX8to16(args.x, map.Width));
            var damagey7 = (short)(effecty7 + Global.PosY8to16(args.y, map.Height));
            /*
            ...
            */
            ...
            arg.effectID = 5622;
            arg.x = Global.PosX16to8(damagex1, map.Width);
            arg.y = Global.PosY16to8(damagey1, map.Height);
            map.SendEventToAllActorsWhoCanSeeActor(Map.EVENT_TYPE.SHOW_EFFECT, arg, sActor, true);

            arg.effectID = 5225;
            arg.x = Global.PosX16to8(damagex2, map.Width);
            arg.y = Global.PosY16to8(damagey2, map.Height);
            map.SendEventToAllActorsWhoCanSeeActor(Map.EVENT_TYPE.SHOW_EFFECT, arg, sActor, true);
            arg.effectID = 5613;
            arg.x = Global.PosX16to8(damagex3, map.Width);
            arg.y = Global.PosY16to8(damagey3, map.Height);
            map.SendEventToAllActorsWhoCanSeeActor(Map.EVENT_TYPE.SHOW_EFFECT, arg, sActor, true);
            arg.effectID = 5065;
            arg.x = Global.PosX16to8(damagex4, map.Width);
            arg.y = Global.PosY16to8(damagey4, map.Height);
            map.SendEventToAllActorsWhoCanSeeActor(Map.EVENT_TYPE.SHOW_EFFECT, arg, sActor, true);
            arg.effectID = 5604;
            arg.x = Global.PosX16to8(damagex5, map.Width);
            arg.y = Global.PosY16to8(damagey5, map.Height);
            map.SendEventToAllActorsWhoCanSeeActor(Map.EVENT_TYPE.SHOW_EFFECT, arg, sActor, true);
            arg.effectID = 5307;
            arg.x = Global.PosX16to8(damagex6, map.Width);
            arg.y = Global.PosY16to8(damagey6, map.Height);
            map.SendEventToAllActorsWhoCanSeeActor(Map.EVENT_TYPE.SHOW_EFFECT, arg, sActor, true);
            arg.effectID = 5619;
            arg.x = Global.PosX16to8(damagex7, map.Width);
            arg.y = Global.PosY16to8(damagey7, map.Height);
            map.SendEventToAllActorsWhoCanSeeActor(Map.EVENT_TYPE.SHOW_EFFECT, arg, sActor, true);
        }
