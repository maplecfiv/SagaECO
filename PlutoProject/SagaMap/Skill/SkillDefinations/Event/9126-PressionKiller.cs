...
namespace SagaMap.Skill.SkillDefinations.Event
{
    public class PressionKiller : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            SkillHandler.Instance.MagicAttack(sActor, new List<Actor> { dActor }, args, SkillHandler.DefType.IgnoreAll,
                Elements.Neutral, 0, factor, 0, false, true);
            var dmg = args.hp[0];
            ...
            foreach (var item in affected)
            {
                ...
                MapManager.Instance.GetMap(sActor.MapID)
                    .SendEventToAllActorsWhoCanSeeActor(Map.EVENT_TYPE.HPMPSP_UPDATE, null, item, true);
            }
