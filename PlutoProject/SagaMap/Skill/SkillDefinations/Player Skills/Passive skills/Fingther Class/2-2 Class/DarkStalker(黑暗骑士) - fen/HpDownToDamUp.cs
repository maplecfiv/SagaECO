...
namespace SagaMap.Skill.SkillDefinations.Player_Skills.Passive_skills.Fingther_Class._2_2_Class.DarkStalker_黑暗骑士____fen
{
    ...
    public class HpDownToDamUp : ISkill
    {
        ...
        {
            var active = true;
            var skill = new DefaultPassiveSkill(args.skill, sActor, "HpDownToDamUp", active);
        ...
        {
            var HPPercent = actor.HP / actor.MaxHP * 100;
            var damUP = 0f;
            if (HPPercent <= 100 && HPPercent > 80)
                ...
                damUP = 0.08f;
            else if (HPPercent <= 20 && HPPercent >= 0) damUP = 0.1f;

            //最大攻擊
            var max_atk1_add = (int)(actor.Status.max_atk_bs * damUP);
            ...
            //最大攻擊
            var max_atk2_add = (int)(actor.Status.max_atk_bs * damUP);
            ...
            //最大攻擊
            var max_atk3_add = (int)(actor.Status.max_atk_bs * damUP);
            ...
            //最小攻擊
            var min_atk1_add = (int)(actor.Status.min_atk_bs * damUP);
            ...
            //最小攻擊
            var min_atk2_add = (int)(actor.Status.min_atk_bs * damUP);
            ...
            //最小攻擊
            var min_atk3_add = (int)(actor.Status.min_atk_bs * damUP);
