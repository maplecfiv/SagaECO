...
namespace SagaMap.Skill.SkillDefinations.Striker
{
    public class BirdDamUp : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            var skill = new DefaultPassiveSkill(args.skill, dActor, "BirdDamUp", active);
        ...
        private void StartEventHandler(Actor actor, DefaultPassiveSkill skill)
        {
            ...
            var addin = level == 5 ? 5 : 0;
            //最小攻擊
            var min_atk1_add = 5 * level + addin;
            ...
            //最小攻擊
            var min_atk2_add = 5 * level + addin;
            ...
            //最小攻擊
            var min_atk3_add = 5 * level + addin;
