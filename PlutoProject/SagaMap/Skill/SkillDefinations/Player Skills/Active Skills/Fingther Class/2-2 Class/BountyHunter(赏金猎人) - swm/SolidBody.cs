...
namespace SagaMap.Skill.SkillDefinations.Player_Skills.Active_Skills.Fingther_Class._2_2_Class.BountyHunter_赏金猎人____swm
{
    ...
    public class SolidBody : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            {
                var lifetimes = new[] { 0, 15000, 30000, 50000, 70000, 90000 };
                var skill = new DefaultBuff(args.skill, realdActor, "SolidBody", lifetimes[level]);
