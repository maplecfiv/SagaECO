...
namespace SagaMap.Skill.SkillDefinations.Player_Skills.Active_Skills.Fingther_Class._2_2_Class.BountyHunter_赏金猎人____swm
{
    ...
    public class AtkUpHitDown : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            var skill = new DefaultBuff(args.skill, dActor, "AtkUpHitDown", lifetime);
        ...
        private void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            int max_atk1_add = 0,
                ...
                max_atk3_add = 0,
                min_atk3_add = 0;
            var hit_range_down = -(int)(actor.Status.hit_ranged * (0.3f * 0.1f * level));
            var hit_melee_down = -(int)(actor.Status.hit_melee * (0.3f * 0.1f * level));
            ...
            min_atk2_add = (int)(actor.Status.min_atk_bs * (0.15f * 0.05f * level));
            max_atk3_add = (int)(actor.Status.max_atk_bs * (0.15f * 0.05f * level));
            min_atk3_add = (int)(actor.Status.min_atk_bs * (0.15f * 0.05f * level));
            //avo_range_down
