    ...
    public class Rush : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            if ((mainlv == 3 || duallv == 3) && (mainlv3 == 5 || mainlv3 == 5))
                factor = new[] { 0, 1.85f, 2.15f, 2.46f, 2.76f, 3.08f }[level];
            else if ((mainlv == 3 || duallv == 3) && (mainlv3 != 5 || mainlv3 != 5))
                factor = new[] { 0, 1.17f, 1.36f, 1.56f, 1.75f, 1.95f }[level];
            else if ((mainlv != 3 || duallv != 3) && (mainlv3 == 5 || mainlv3 == 5))
                factor = new[] { 0, 1.42f, 1.65f, 1.89f, 2.13f, 2.37f }[level];
            else
                factor = new[] { 0, 0.9f, 1.05f, 1.2f, 1.35f, 1.5f }[level];
