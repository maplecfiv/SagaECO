...
namespace SagaMap.Skill.SkillDefinations.Player_Skills.Active_Skills.Spell_User_Class._2_2_Class.Bard_诗人____vote
{
    ...
    public class Samba : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            //註冊施放者的Buff
            var skill = new DefaultBuff(args.skill, sActor, "DefUpCircle_Caster", 6000 + 2000 * level);
        ...
        private class Activator : MultiRunTask
        {
                    ...
                    if (count < countMax)
                    {
                        ...
                        foreach (var act in actors)
                            if (act.type == ActorType.PC || act.type == ActorType.PET)
                                ...
                                {
                                    var skill2 = new DefaultBuff(skill.skill, act, "DefUpCircle",
            ...
            private void StartEventHandler(Actor actor, DefaultBuff skill)
            {
                ...
                var ldefs = new short[] { 0, 5, 7, 8, 9, 10 };
                var LDef = ldefs[level];
                var RDef = (short)(10 * level);
                //左防
