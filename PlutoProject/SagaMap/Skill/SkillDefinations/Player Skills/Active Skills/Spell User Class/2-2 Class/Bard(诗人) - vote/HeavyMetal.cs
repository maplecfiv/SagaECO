...
namespace SagaMap.Skill.SkillDefinations.Player_Skills.Active_Skills.Spell_User_Class._2_2_Class.Bard_诗人____vote
{
    ...
    ///     重金屬演奏（ヘヴィメタル）
    /// </summary>
    public class HeavyMetal : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            //註冊施放者的Buff
            var skill = new DefaultBuff(args.skill, sActor, "HeavyMetal_Caster", 30000 + 30000 * level);
        ...
        private class Activator : MultiRunTask
        {
            ...
            private void StartEventHandler(Actor actor, DefaultBuff skill)
            {
                ...
                //近戰迴避
                actor.Status.avoid_melee_skill += (short)(2 + 8 * level);

                //遠距迴避
                actor.Status.avoid_ranged_skill += (short)(2 + 8 * level);
