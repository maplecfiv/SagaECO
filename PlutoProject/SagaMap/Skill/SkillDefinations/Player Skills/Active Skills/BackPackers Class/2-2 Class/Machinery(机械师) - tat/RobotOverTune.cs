...
namespace SagaMap.Skill.SkillDefinations.Player_Skills.Active_Skills.BackPackers_Class._2_2_Class.Machinery_机械师____tat
{
    ...
    public class RobotOverTune : ISkill
    {
        ...
        {
            var lifetime = 30000 + 20000 * level;
            var skill = new DefaultBuff(args.skill, dActor, "RobotOverTune", lifetime);
        ...
        private void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            //最大攻擊
            var max_atk1_add = (int)(actor.Status.max_atk_bs * (0.05f + 0.1f * level));
            ...
            //最大攻擊
            var max_atk2_add = (int)(actor.Status.max_atk_bs * (0.05f + 0.1f * level));
            ...
            //最大攻擊
            var max_atk3_add = (int)(actor.Status.max_atk_bs * (0.05f + 0.1f * level));
            ...
            //最小攻擊
            var min_atk1_add = (int)(actor.Status.min_atk_bs * (0.05f + 0.1f * level));
            ...
            //最小攻擊
            var min_atk2_add = (int)(actor.Status.min_atk_bs * (0.05f + 0.1f * level));
            ...
            //最小攻擊
            var min_atk3_add = (int)(actor.Status.min_atk_bs * (0.05f + 0.1f * level));
            ...
            //最大魔攻
            var max_matk_add = (int)(actor.Status.max_matk * (0.05f + 0.1f * level));
            ...
            //最小魔攻
            var min_matk_add = (int)(actor.Status.min_matk * (0.05f + 0.1f * level));
