...
namespace SagaMap.Skill.SkillDefinations.Marionest
{
    ...
    public class MarioDamUp : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            {
                var sAct = (ActorPC)sActor;
                if (sAct.Marionette != null) active = true;
            }

            var skill = new DefaultPassiveSkill(args.skill, sActor, "MarioDamUp", active);
        ...
        private void StartEventHandler(Actor actor, DefaultPassiveSkill skill)
        {
            ...
            //最大攻擊
            var max_atk1_add = (int)(actor.Status.max_atk_bs * (0.07f + 0.03f * level));
            ...
            //最大攻擊
            var max_atk2_add = (int)(actor.Status.max_atk_bs * (0.07f + 0.03f * level));
            ...
            //最大攻擊
            var max_atk3_add = (int)(actor.Status.max_atk_bs * (0.07f + 0.03f * level));
            ...
            //最小攻擊
            var min_atk1_add = (int)(actor.Status.min_atk_bs * (0.07f + 0.03f * level));
            ...
            //最小攻擊
            var min_atk2_add = (int)(actor.Status.min_atk_bs * (0.07f + 0.03f * level));
            ...
            //最小攻擊
            var min_atk3_add = (int)(actor.Status.min_atk_bs * (0.07f + 0.03f * level));
            ...
            //最小魔攻
            var min_matk_add = (int)(actor.Status.min_matk * (0.07f + 0.03f * level));
            ...
            //左防禦
            var def_add = (int)(actor.Status.def * (0.07f + 0.03f * level));
            ...
            //右防禦
            var def_add_add = (int)(actor.Status.def_add * (0.07f + 0.03f * level));
            ...
            //左魔防
            var mdef_add = (int)(actor.Status.mdef * (0.07f + 0.03f * level));
            ...
            //右魔防
            var mdef_add_add = (int)(actor.Status.mdef_add * (0.07f + 0.03f * level));
