...
namespace SagaMap.Skill.SkillDefinations.Hawkeye
{
    public class TimeBomb : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            timer.Activate();
            SkillHandler.Instance.PhysicalAttack(sActor, dActor, args, SagaLib.Elements.Neutral, 1.5f + 0.3f * level);
            ...
            public override void CallBack()
            {
                ...
                try
                {
                    if (count < countMax)
                    {
                        ...
                        SkillHandler.Instance.PhysicalAttack(caster, affected, skill, SagaLib.Elements.Neutral, factor);
