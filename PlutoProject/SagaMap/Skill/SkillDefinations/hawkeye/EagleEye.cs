...
namespace SagaMap.Skill.SkillDefinations.Hawkeye
{
    ...
    public class EagleEye : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            int atk1_add_min = (int)(actor.Status.min_atk_bs * rate);
            ...
            int atk2_add_min = (int)(actor.Status.min_atk_bs * rate);
            ...
            int atk3_add_min = (int)(actor.Status.min_atk_bs * rate);
            ...
            int atk1_add_max = (int)(actor.Status.max_atk_bs * rate);
            ...
            int atk2_add_max = (int)(actor.Status.max_atk_bs * rate);
            ...
            int atk3_add_max = (int)(actor.Status.max_atk_bs * rate);
