...
namespace SagaMap.Skill.SkillDefinations.Global.Passive
{
    ...
    public class AtkUpByPt : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            if (sActorPC.Party != null) active = true;
            var skill = new DefaultPassiveSkill(args.skill, sActor, "AtkUpByPt", active);
        ...
        public void StartEventHandler(Actor actor, DefaultPassiveSkill skill)
        {
            ...
            var atk_add = new[] { 0, 0.01f, 0.03f, 0.06f }[level];
            //最大攻擊
            var max_atk1_add = (int)(actor.Status.max_atk_bs * atk_add);
            ...
            //最大攻擊
            var max_atk2_add = (int)(actor.Status.max_atk_bs * atk_add);
            ...
            //最大攻擊
            var max_atk3_add = (int)(actor.Status.max_atk_bs * atk_add);
            ...
            //最小攻擊
            var min_atk1_add = (int)(actor.Status.min_atk_bs * atk_add);
            ...
            //最小攻擊
            var min_atk2_add = (int)(actor.Status.min_atk_bs * atk_add);
            ...
            //最小攻擊
            var min_atk3_add = (int)(actor.Status.min_atk_bs * atk_add);
