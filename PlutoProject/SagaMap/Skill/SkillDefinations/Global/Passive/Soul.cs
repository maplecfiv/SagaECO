...
namespace SagaMap.Skill.SkillDefinations.Global
{
    ...
    public class Soul : ISkill
    {
        ...
        private void DeleteSkill(Actor actor, DefaultPassiveSkill skill)
        {
            ...
            //大傷
            actor.Status.max_atk1_possession = 0; //-= (short)skill.Variable["Soul_max_atk_bs_add"];
        ...
        private void SetupSkill(Actor actor, DefaultPassiveSkill skill)
        {
            ...
            if (actorPC.PossessionPosition == PossessionPosition.RIGHT_HAND)
            {
                ...
                avo_ranged_add = (int)(actor.Status.avoid_ranged * 0.06);
                hit_melee_add = (int)(actor.Status.avoid_ranged * 0.14);
                hit_ranged_add = (int)(actor.Status.avoid_ranged * 0.14);
                left_def_add = (int)(actor.Status.def * 0.03);
                //right_def_add = (int)(actor.Status.def * def);
                left_mdef_add = (int)(actor.Status.mdef * 0.03);
            ...
            else if (actorPC.PossessionPosition == PossessionPosition.LEFT_HAND)
            {
                ...
                avo_ranged_add = (int)(actor.Status.avoid_ranged * 0.07);
                hit_melee_add = (int)(actor.Status.avoid_ranged * 0.06);
                hit_ranged_add = (int)(actor.Status.avoid_ranged * 0.06);
                left_def_add = (int)(actor.Status.def * 0.13);
                //right_def_add = (int)(actor.Status.def * def);
                left_mdef_add = (int)(actor.Status.mdef * 0.13);
                //right_mdef_add = (int)(actor.Status.mdef * def);
            ...
            else if (actorPC.PossessionPosition == PossessionPosition.NECK)
            {
                ...
                avo_ranged_add = (int)(actor.Status.avoid_ranged * 0.14);
                hit_melee_add = (int)(actor.Status.avoid_ranged * 0.09);
                hit_ranged_add = (int)(actor.Status.avoid_ranged * 0.09);
                left_def_add = (int)(actor.Status.def * 0.07);
                //right_def_add = (int)(actor.Status.def * def);
            ...
            else if (actorPC.PossessionPosition == PossessionPosition.CHEST)
            {
                ...
                avo_ranged_add = (int)(actor.Status.avoid_ranged * 0.06);
                hit_melee_add = (int)(actor.Status.avoid_ranged * 0.05);
                hit_ranged_add = (int)(actor.Status.avoid_ranged * 0.05);
                left_def_add = (int)(actor.Status.def * 0.07);
                //right_def_add = (int)(actor.Status.def * def);
                left_mdef_add = (int)(actor.Status.mdef * 0.07);
                //right_mdef_add = (int)(actor.Status.mdef * def);
            ...
            //大傷
            if (skill.Variable.ContainsKey("Soul_max_atk_bs_add"))
                skill.Variable.Remove("Soul_max_atk_bs_add");
            skill.Variable.Add("Soul_max_atk_bs_add", max_atk_bs_add);
            actor.Status.max_atk1_possession = (short)max_atk_bs_add;

            if (skill.Variable.ContainsKey("Soul_max_atk_bs_add"))
                skill.Variable.Remove("Soul_max_atk_bs_add");
            skill.Variable.Add("Soul_max_atk_bs_add", max_atk_bs_add);
            actor.Status.max_atk2_possession = (short)max_atk_bs_add;

            if (skill.Variable.ContainsKey("Soul_max_atk_bs_add"))
                skill.Variable.Remove("Soul_max_atk_bs_add");
            skill.Variable.Add("Soul_max_atk_bs_add", max_atk_bs_add);
            actor.Status.max_atk3_possession = (short)max_atk_bs_add;
            //小傷
            if (skill.Variable.ContainsKey("Soul_min_atk_bs_add"))
                skill.Variable.Remove("Soul_min_atk_bs_add");
            skill.Variable.Add("Soul_min_atk_bs_add", min_atk_bs_add);
            actor.Status.min_atk1_possession = (short)min_atk_bs_add;

            if (skill.Variable.ContainsKey("Soul_min_atk_bs_add"))
                skill.Variable.Remove("Soul_min_atk_bs_add");
            skill.Variable.Add("Soul_min_atk_bs_add", min_atk_bs_add);
            actor.Status.min_atk2_possession = (short)min_atk_bs_add;
