...
namespace SagaMap.Skill.SkillDefinations.Marionette
{
    ...
    public class MBokeboke : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            var skill = new DefaultBuff(args.skill, dActor, "MBokeboke", lifetime);
        ...
        {
            //最大攻擊
            var max_atk1_add = -(int)(actor.Status.max_atk1 * 0.1f);
            ...
            //最大攻擊
            var max_atk2_add = -(int)(actor.Status.max_atk2 * 0.1f);
            ...
            //最大攻擊
            var max_atk3_add = -(int)(actor.Status.max_atk3 * 0.1f);
            ...
            //最小攻擊
            var min_atk1_add = -(int)(actor.Status.min_atk1 * 0.1f);
            ...
            //最小攻擊
            var min_atk2_add = -(int)(actor.Status.min_atk2 * 0.1f);
            ...
            //最小攻擊
            var min_atk3_add = -(int)(actor.Status.min_atk3 * 0.1f);
            ...
            //最大魔攻
            var max_matk_add = -(int)(actor.Status.max_matk * 0.1f);
            ...
            //最小魔攻
            var min_matk_add = -(int)(actor.Status.min_matk * 0.1f);
