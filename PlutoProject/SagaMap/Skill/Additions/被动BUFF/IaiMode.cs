...
namespace SagaMap.Skill.Additions.被动BUFF
{
    ...
    public class IaiMode : DefaultBuff
    {
        ...
        private void StartEvent(Actor actor, DefaultBuff skill)
        {
            ...
            {
                var skill2 = SkillFactory.Instance.GetSkill(2178, 1);
            ...
            //最大攻擊
            var max_atk1_add = (int)(actor.Status.max_atk_bs * rate);
            ...
            //最大攻擊
            var max_atk2_add = (int)(actor.Status.max_atk_bs * rate);
            ...
            //最大攻擊
            var max_atk3_add = (int)(actor.Status.max_atk_bs * rate);
            ...
            //最小攻擊
            var min_atk1_add = (int)(actor.Status.min_atk_bs * rate);
            ...
            //最小攻擊
            var min_atk2_add = (int)(actor.Status.min_atk_bs * rate);
            ...
            //最小攻擊
            var min_atk3_add = (int)(actor.Status.min_atk_bs * rate);
        ...
        private void EndEvent(Actor actor, DefaultBuff skill)
        {
            if (actor.type == ActorType.PC)
            {
                MapClient.FromActorPC((ActorPC)actor).SendSystemMessage("居合姿势取消。");
                actor.Speed = 410;
                if (((ActorPC)actor).Skills.ContainsKey(2178))
