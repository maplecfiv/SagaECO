...
namespace SagaMap.Skill.Additions
{
    public class Poison : DefaultBuff
    {
        ...
        private void StartEvent(Actor actor, DefaultBuff skill)
        {
            ...
            //最大攻擊
            var max_atk2_add = actor.Status.max_atk_bs / 2;
            ...
            //最大攻擊
            var max_atk3_add = actor.Status.max_atk_bs / 2;
            ...
            //最小攻擊
            var min_atk1_add = actor.Status.min_atk_bs / 2;
            ...
            //最小攻擊
            var min_atk2_add = actor.Status.min_atk_bs / 2;
            ...
            //最小攻擊
            var min_atk3_add = actor.Status.min_atk_bs / 2;
            ...
            //最小魔攻
            var min_matk_add = actor.Status.min_matk_bs / 2;
            ...
            //最大魔攻
            var max_matk_add = actor.Status.max_matk_bs / 2;
