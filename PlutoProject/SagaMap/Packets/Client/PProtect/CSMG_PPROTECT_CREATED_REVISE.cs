...
{
    public class CSMG_PPROTECT_CREATED_REVISE : Packet
    {
        ...
        public CSMG_PPROTECT_CREATED_REVISE()
        {
            offset = 2;
        }
        ...
        {
            return new CSMG_PPROTECT_CREATED_REVISE();
        }

        public override void Parse(SagaLib.Client client)
        {
            load();
            ((MapClient)client).OnPProtectCreatedRevise(this);
        }
    }
}